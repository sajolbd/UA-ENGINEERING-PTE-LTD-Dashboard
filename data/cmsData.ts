...
export const initialCmsData: CmsDatabase = {
  ...
  "home": {
    "content": {
      ...
      "processStep1Image": "/images/home/process/assessment.webp",
      ...
      "processStep2Image": "/images/home/process/planning.webp",
      ...
      "processStep3Image": "/images/home/process/execution.webp",
      ...
      "processStep4Image": "/images/home/process/handover.webp",
      ...
      "areaHeading": "Reliable Engineering & Renovation Solutions Near You",
      "areaSubheading": "UA ENGINEERING proudly provides renovation and upgrading services across Singapore, covering all major residential and commercial areas.",
      "regions": [
        {
      ...
      "faqsJson": "[{\"question\":\"1. What services does UA Engineering provide in Singapore?\",\"answer\":\"We provide comprehensive building and property solutions including residential and commercial renovation & upgrading, structural steel works, roof extension, interior & exterior painting, waterproofing, electrical rewiring, plumbing, aircon servicing, aluminium glazing, and solar panel installation across Singapore.\"},{\"question\":\"2. Does UA Engineering handle both residential and commercial projects?\",\"answer\":\"Yes. We undertake projects for HDB flats, BTO, condominiums, landed homes, commercial offices, retail shops, and industrial properties across Singapore. Our team manages projects of all scales, from individual repair works to complete property transformations.\"},{\"question\":\"3. Are your engineers, technicians, and workers licensed and certified in Singapore?\",\"answer\":\"Yes, our team consists of BCA-certified professionals, EMA-licensed electricians, and trained Workplace Safety and Health (WSH) officers compliant with Singapore building safety standards and MOM regulations.\"},{\"question\":\"4. How does the renovation and engineering process work?\",\"answer\":\"Our process begins with a consultation and site assessment, followed by a detailed proposal and project planning. Once approved, our skilled team carries out the works under professional supervision and strict quality control. The project concludes with final inspection, handover, site cleaning, and after-sales support.\"},{\"question\":\"5. Do you provide a detailed quotation before starting work?\",\"answer\":\"Yes. We provide transparent, itemised quotations outlining the project scope, materials, pricing, and expected timeline. This helps clients understand all costs clearly with no hidden fees or unexpected charges.\"},{\"question\":\"6. Do you offer free site inspections and non-obligatory quotations?\",\"answer\":\"Yes! We offer free site assessments across all Singapore regions to evaluate your property's requirements, take accurate measurements, and provide clear, transparent upfront quotations.\"},{\"question\":\"7. How quickly can UA Engineering start our project upon confirmation?\",\"answer\":\"Once the project scope and quotations are approved, our project management team arranges site preparation, permit submissions, and material delivery to commence works promptly according to agreed timelines.\"},{\"question\":\"8. Do you provide waterproofing, plumbing, electrical, and air-conditioning services?\",\"answer\":\"Yes. We provide a wide range of essential M&E and building services, including roof and bathroom waterproofing, leak repairs, pipe replacement, electrical rewiring, switchboard upgrades, and air-conditioning installations.\"},{\"question\":\"9. How does UA Engineering ensure quality, safety, and timely project completion?\",\"answer\":\"We use structured project planning, experienced supervision, quality inspections, premium certified materials, and strict safety standards (WSH). Clear communication and efficient scheduling ensure every project is completed reliably and on time.\"},{\"question\":\"10. Do you provide warranty and after-sales maintenance support?\",\"answer\":\"Yes, we provide warranty coverage on our workmanship and materials, along with responsive after-sales maintenance support to give you complete confidence and peace of mind after project handover.\"}]"
    },
    "seo": {
      "metaTitle": "UA Engineering PTE. LTD. | Singapore Engineering & Renovation",
      "metaDescription": "UA Engineering PTE. LTD. provides renovation, waterproofing, steel works, roofing, electrical, plumbing, aircon, aluminium glazing and maintenance services across Singapore.",
  ...
  "services": {
    "content": {
      ...
      "serviceAreasTitle": "Reliable Engineering & Renovation Solutions Near You",
      "serviceAreasSubtitle": "UA ENGINEERING proudly provides renovation and upgrading services across Singapore, covering all major residential and commercial areas.",
      "regions": [
        {
          "region": "Central Region",
          "name": "Central Region",
